...
def update_args(args):
    args.model_name = args.method + "_" + args.model_type + "_layers_" + str(args.unet_layers)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type=str, default='/scratch/svaidy33/CMB_detection/CMB-Segmentation/CMB_dataset/')
    ...
    parser.add_argument('--output_path', type=str, default='./seg_results_woce/')
